...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2022 at 08:14 PM
...
--
ALTER TABLE `cmnt_notification`
  MODIFY `sl` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `quiz_result`
  MODIFY `sl` int(111) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
