...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2022 at 10:03 PM
...
(1, '1', 15, 'Sifat Bin Hossain Comment on your post.', '1', '0000-00-00 00:00:00.000000', 1),
(2, '1', 15, 'Sifat Bin Hossain Comment on your post.', '1', '2022-12-22 22:49:26.761929', 1),
...
(6, '3', 15, 'Sifat Bin Hossain Comment on your post.', '1', '2022-12-24 01:05:22.931151', 1),
(7, '5', 1, 'Abu Sayem Md Siam Comment on your post.', '1', '2022-12-24 01:06:27.191192', 1),
(8, '2', 1, 'Abu Sayem Md Siam Comment on your post.', '15', '2022-12-30 12:26:44.137225', 1),
(9, '2', 1, 'Abu Sayem Md Siam Comment on your post.', '15', '2022-12-30 12:26:56.682824', 1),
(10, '2', 1, 'Abu Sayem Md Siam Comment on your post.', '15', '2022-12-30 12:27:03.051957', 1),
(11, '5', 1, 'Abu Sayem Md Siam Comment on your post.', '15', '2022-12-30 12:27:24.718210', 1),
(12, '1', 15, 'Sifat Bin Hossain Comment on your post.', '15', '2022-12-31 02:22:59.525388', 0);
...
('Md. Sabbir', 15, 'WhatsApp Image 2022-11-05 at 19.31.57.jpg', 2, 30, 'yes try this\r\n'),
('Md. Sabbir', 15, 'WhatsApp Image 2022-11-05 at 19.31.57.jpg', 2, 31, 'can do better'),
('Md. Sabbir', 15, 'WhatsApp Image 2022-11-05 at 19.31.57.jpg', 2, 32, 'can do better'),
('Md. Sabbir', 15, 'WhatsApp Image 2022-11-05 at 19.31.57.jpg', 5, 33, 'learn java');
...
--
-- Table structure for table `comreview`
--
...
--
-- Dumping data for table `comreview`
--

INSERT INTO `comreview` (`acc_id`, `com_id`, `rating`, `review`) VALUES
(15, 9, 4, 'very Good'),
(15, 9, 5, 'well organized '),
(15, 4, 5, 'very decent '),
(15, 4, 2, 'poor management '),
(15, 5, 1, 'not well');
...
INSERT INTO `event_photo` (`event_id`, `pic`, `time`) VALUES
(3, 'Screenshot 2021-12-22 223107.jpg', '2022-12-30 22:36:03.786577'),
(3, '316806911_505967144896996_6299547776197234345_n.jpg', '2022-12-30 22:49:13.087246');
...
(1, 5, 6, 'img_avatar.png', 'ac', 'awwer@gmail.com', 0, 'awc', 'wd', 'download.jpeg'),
(1, 5, 7, 'img_avatar.png', 'wd', 'awwer@gmail.com', 0, 'wda', 'dwa', 'Print PC - PC Builder - Star Tech.pdf'),
(1, 4, 8, 'img_avatar.png', 'ad', 'awd@cdsc', 0, 'awdwa', 'wda', '011201033 Abu Sayem Md. Siam.pdf');
...
INSERT INTO `quiz_result` (`acc_id`, `score`, `category`, `sl`) VALUES
(1, 40, 'Java', 2),
(1, 100, 'C++', 3),
(1, 16, 'C++', 4),
(15, 20, 'Java', 5),
...
INSERT INTO `qus_info` (`qus_code`, `sl`, `qus_title`, `qus_des`, `total_qus`, `Catagory`) VALUES
('CSE100 ', 2, 'Basic of Computer Science', 'Basic question of Computer Science this Quiz Contain 10 MCQ', 10, 'General Knowledge'),
('CSE101', 4, 'C Quiz', 'Basic question of C this Quiz Contain 10 MCQ', 5, 'C++'),
('CSE200', 7, 'C Quiz', 'Basic question of Computer Science this Quiz Contain 10 MCQ', 5, 'C++'),
('CSE105', 8, 'Basic C Quiz', 'Basic knowledge of C', 6, 'C++'),
('CSE2211', 9, 'Java', 'About java', 3, 'Java');
...
CREATE TABLE `user_info` (
  ...
  `photo_loc` varchar(150) NOT NULL,
...
(1, 0, '', '145,Dhaka,bangladesh', 'sayemsiam198@gmail.com', '01884928033', '728709.jpg', 'Motijheel Model school and College', 'St. Gregory School and College', 'United Internatinal University', 'N/A', 'N/A', '2017', '2019', '2024', 'N/A', 'N/A', '5.00', '4.42', '3.50', 'N/A', 'Python,C++,C,HTML,CSS,PHP,JAVA', 'Bangla,English,Hindi', 'https://www.facebook.com/duronto.sayem.7', 'https://www.facebook.com/messages/t/100010296760824', 'N/A'),
...
(19, 0, 'Hi I am Mr. Two', 'w34,Khulna', 'wer@gmail.com', '01814689066', 'businessman-icon-vector-male-avatar-profile-image-profile-businessman-icon-vector-male-avatar-profile-image-182095609.jpg', 'Khulna Zela School', 'Khulna Govt. College', 'United International Ubiversity', 'N/A', 'N/A', '2017', '2019', '2023', 'N/A', 'N/A', '5.00', '5.00', '3.88', 'N/A', 'Python, Java', 'English, Bangla', 'N/A', 'N/A', 'N/A'),
(3, 0, '', 'Khilga,Dhaka', 'mzidan@gmail.com', '427425400', 'businessman-icon-vector-male-avatar-profile-image-profile-businessman-icon-vector-male-avatar-profile-image-182095609.jpg', 'MMSAC', 'BMAR', 'UIU', 'N/A', 'N/A', '2017', '2019', '2024', 'N/A', 'N/A', '5.00', '4.50', '3.4', 'N/A', 'C,C++,Java', 'English,Hindi', 'N/A', 'N/A', 'N/A');
...
--
ALTER TABLE `communitycomment`
  MODIFY `comment_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `job_applicant`
  MODIFY `applicant_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `quiz_result`
  MODIFY `sl` int(111) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `event_photo`
  ADD CONSTRAINT `event_photo_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `event_info` (`event_id`);
...
--
ALTER TABLE `quiz_score`
  ADD CONSTRAINT `quiz_score_ibfk_1` FOREIGN KEY (`acc_id`) REFERENCES `accounts` (`acc_id`);
